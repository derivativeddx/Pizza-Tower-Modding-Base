...
fakepep_set_attack(0, 0, fakepep_attacks.grab, 80, default_deformed_timer);
fakepep_set_attack(0, 1, fakepep_attacks.bodyslam, 80, default_deformed_timer);
fakepep_set_attack(0, 2, fakepep_attacks.mach, 120, default_deformed_timer);
fakepep_set_attack(0, 3, fakepep_attacks.superjump, 120, 500);
fakepep_set_attack(0, 4, fakepep_attacks.throwhead, 120, default_deformed_timer);
fakepep_set_attack(0, 5, fakepep_attacks.taunt, 120, 700);

fakepep_set_attack(1, 0, fakepep_attacks.grab, 80, 0);
fakepep_set_attack(1, 1, fakepep_attacks.bodyslam, 80, 0);
fakepep_set_attack(1, 2, fakepep_attacks.mach, 120, 0);
fakepep_set_attack(1, 3, fakepep_attacks.superjump, 120, 0);
fakepep_set_attack(1, 4, fakepep_attacks.throwhead, 120, 0);
fakepep_set_attack(1, 5, fakepep_attacks.taunt, 120, 0);
