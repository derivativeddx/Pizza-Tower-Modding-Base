...
{
	if (obj_achievementtracker.character == "P" && !global.swapmode)
	{
		var type = _array[0];
...
add_achievement_notify("pal_racer", noone, function(_array)
{
	if (obj_achievementtracker.character == "N")
	{
		...
		if (type == notifications.game_beaten)
		{
			var game = global.game[global.currentsavefileindex - 1];
...
{
	if (obj_achievementtracker.character == "N" && instance_exists(obj_tv))
	{
