function scr_playersounds()
{
	with (obj_player)
	{
		...
		{
		    case "N":
		        // Noise doesn't play mach sounds
		        fmod_event_instance_stop(machsnd, true);
		        break;
            
		    default:  // Peppino and other characters
		        if (state == states.mach2 || state == states.mach3 || state == states.climbwall || (state == states.rocket && sprite_index != spr_rocketstart))
		        {
